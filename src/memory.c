...
static void markRoots() {
    ...
    markCompilerRoots();
    markObject((Obj*)vm.currentModule);
...
#ifdef DEBUG_LOG_GC
    printf("-- gc end\n");
    printf("   collected %zu bytes (from %zu to %zu) at next at %zu", before - vm.bytesAllocated, before, vm.bytesAllocated, vm.nextGC);
#endif
}
